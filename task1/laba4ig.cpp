...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pGround->LoadMesh("C:/Program Files/Content/quad.obj")) {
            return false;
        }

        if (!m_billboardList.Init("C:/Program Files/Content/monster_hellknight.png")) {
            return false;
        }

        m_pTexture = new Texture(GL_TEXTURE_2D, "C:/Program Files/Content/bricks.jpg");
        ...
        m_pNormalMap = new Texture(GL_TEXTURE_2D, "C:/Program Files/Content/normal_map.jpg");
