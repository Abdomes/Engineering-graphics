...
public:
    ...
    Main()
    {
        ...
        m_spotLight.Position = Vector3f(-20.0, 25.0, 1.0f);
        m_spotLight.Direction = Vector3f(1.0f, -1.0f, 0.0f);
        m_spotLight.Cutoff = 20.0f;

        lights[0] = m_spotLight;
    }
    ...
    bool Init()
    {
        ...
        m_pLightingEffect->SetSpotLights(1, lights);
        ...
        if (!m_pQuad->LoadMesh("C:/Program Files/Content/quad.obj")) {
            return false;
        }

        m_pGroundTex = new Texture(GL_TEXTURE_2D, "C:/Program Files/Content/test.png");
        ...
        return m_pMesh->LoadMesh("C:/Program Files/Content/phoenix_ugv.md2");
    }
